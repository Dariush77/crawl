...
base_url = "https://mosbatesabz.com/product-category/supplements-2/"
...
# Save the Excel file
workbook.save('Supplment.xlsx')

print("Data has been successfully scraped and saved to 'Supplment.xlsx'")
