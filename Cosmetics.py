...
base_url = "https://mosbatesabz.com/product-category/cosmetics-2/"
...
# Save the Excel file
workbook.save('Cosmetics.xlsx')

print("Data has been successfully scraped and saved to 'Cosmetics.xlsx'")
